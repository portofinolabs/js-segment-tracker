...
```javascript
<script defer id="data-page-viewed-event-name" data-page-viewed-event-name="Page Viewed" src="https://cdn.jsdelivr.net/gh/portofinolabs/js-segment-tracker@v1.0.5/index.js"></script>
```
